  ...
  <tr>
    <td align="center" class="ew" style="padding:32px 16px;">
      <table width="100%" cellpadding="0" cellspacing="0" border="0" role="presentation" style="max-width:560px;" class="ec">
        ...
        <!-- brand header -->
        <tr>
          <td bgcolor="#a10606" style="border-radius:10px 10px 0 0;padding:18px 32px;text-align:center;">
...
<tr>
  <td class="cp" style="padding:36px 32px 0;">
    <p style="margin:0 0 6px;font-family:'Segoe UI',Arial,sans-serif;font-size:10px;font-weight:700;letter-spacing:4px;text-transform:uppercase;color:#a10606;">IT&rsquo;S HERE.</p>
    <p style="margin:0 0 16px;font-family:'Segoe UI',Arial,sans-serif;font-size:24px;font-weight:800;color:#ffffff;line-height:1.25;">${name}, your <span style="color:#a10606;">${productName}</span>${badge ? ' <span style="font-size:16px;color:#888888;font-weight:400;">(' + badge + ')</span>' : ''} has been delivered.</p>
...
<tr>
  <td class="cp" style="padding:24px 32px 0;">
    <table width="100%" cellpadding="0" cellspacing="0" border="0" role="presentation" style="border-left:3px solid #a10606;background-color:#141414;border-radius:0 6px 6px 0;">
      <tr>
        <td style="padding:14px 16px;">
          <p style="margin:0 0 6px;font-family:'Segoe UI',Arial,sans-serif;font-size:9px;font-weight:700;letter-spacing:3px;text-transform:uppercase;color:#a10606;">KEEP IT FRESH</p>
...
<tr>
  <td class="cp" style="padding:22px 32px 0;">
    <p style="margin:0;font-family:'Segoe UI',Arial,sans-serif;font-size:14px;color:#666666;line-height:1.6;">Wearing it? Tag us <a href="https://instagram.com/chunkz_thebrand" style="color:#a10606;text-decoration:none;font-weight:700;">@chunkz_thebrand</a> and we will repost.</p>
  </td>
</tr>
...
<tr>
  <td class="cp" style="padding:36px 32px 0;">
    <p style="margin:0 0 6px;font-family:'Segoe UI',Arial,sans-serif;font-size:10px;font-weight:700;letter-spacing:4px;text-transform:uppercase;color:#a10606;">3 DAYS IN.</p>
    <p style="margin:0 0 16px;font-family:'Segoe UI',Arial,sans-serif;font-size:24px;font-weight:800;color:#ffffff;line-height:1.25;">${name}, how&rsquo;s <span style="color:#a10606;">${productName}</span> working out?</p>
      ...
      <tr>
        <td width="49%" align="center">
          <table cellpadding="0" cellspacing="0" border="0" role="presentation" style="width:100%;">
            <tr>
              <td align="center" bgcolor="#a10606" style="border-radius:6px;">
...
<tr>
  <td class="cp" style="padding:36px 32px 0;">
    <p style="margin:0 0 6px;font-family:'Segoe UI',Arial,sans-serif;font-size:10px;font-weight:700;letter-spacing:4px;text-transform:uppercase;color:#a10606;">ONE QUICK THING.</p>
    <p style="margin:0 0 16px;font-family:'Segoe UI',Arial,sans-serif;font-size:24px;font-weight:800;color:#ffffff;line-height:1.25;">You&rsquo;ve had <span style="color:#a10606;">${productName}</span> for about a week now.</p>
    ...
    <p style="margin:0 0 28px;font-family:'Segoe UI',Arial,sans-serif;font-size:15px;color:#888888;line-height:1.6;"><a href="${followUpUrl}" target="_blank" style="color:#a10606;font-weight:700;text-decoration:none;">Tap here to drop your feedback &rarr;</a></p>
  </td>
</tr>
...
<tr>
  <td class="cp" style="padding:36px 32px 0;">
    <p style="margin:0 0 6px;font-family:'Segoe UI',Arial,sans-serif;font-size:10px;font-weight:700;letter-spacing:4px;text-transform:uppercase;color:#a10606;">THOUGHT YOU&rsquo;D LIKE THIS.</p>
    <p style="margin:0 0 16px;font-family:'Segoe UI',Arial,sans-serif;font-size:24px;font-weight:800;color:#ffffff;line-height:1.25;">Since you got the <span style="color:#a10606;">${productName}</span>, this one caught our eye for you.</p>
    ...
    <table width="100%" cellpadding="0" cellspacing="0" border="0" role="presentation" style="background-color:#181818;border-radius:${rec.imageUrl ? '0 0 8px 8px' : '8px'};">
      <tr>
        <td style="padding:18px 20px;">
          ...
          ${priceRow}
          <p style="margin:12px 0 0;font-family:'Segoe UI',Arial,sans-serif;font-size:14px;"><a href="${buyNowUrl}" target="_blank" style="color:#a10606;font-weight:700;text-decoration:none;">Take a look &rarr;</a></p>
        </td>
      </tr>
    </table>
  </td>
...
<tr>
  <td class="cp" style="padding:36px 32px 0;">
    <p style="margin:0 0 6px;font-family:'Segoe UI',Arial,sans-serif;font-size:10px;font-weight:700;letter-spacing:4px;text-transform:uppercase;color:#a10606;">${cfg.label}</p>
...
<tr>
  <td class="cp" style="padding:18px 32px 0;">
    <p style="margin:0;font-family:'Segoe UI',Arial,sans-serif;font-size:13px;color:#444444;text-align:center;line-height:1.6;">Questions? Reach us on Instagram <a href="https://instagram.com/chunkz_thebrand" style="color:#a10606;text-decoration:none;font-weight:700;">@chunkz_thebrand</a></p>
  </td>
</tr>`;
...
<tr>
  <td class="cp" style="padding:36px 32px 0;">
    <p style="margin:0 0 6px;font-family:'Segoe UI',Arial,sans-serif;font-size:10px;font-weight:700;letter-spacing:4px;text-transform:uppercase;color:#a10606;">CONFIRMED.</p>
...
<tr>
  <td class="cp" style="padding:36px 32px 0;">
    <p style="margin:0 0 6px;font-family:'Segoe UI',Arial,sans-serif;font-size:10px;font-weight:700;letter-spacing:4px;text-transform:uppercase;color:#a10606;">IN THE WORKS.</p>
...
<tr>
  <td class="cp" style="padding:36px 32px 0;">
    <p style="margin:0 0 6px;font-family:'Segoe UI',Arial,sans-serif;font-size:10px;font-weight:700;letter-spacing:4px;text-transform:uppercase;color:#a10606;">ON ITS WAY.</p>
    <p style="margin:0 0 16px;font-family:'Segoe UI',Arial,sans-serif;font-size:24px;font-weight:800;color:#ffffff;line-height:1.25;">${name}, your <span style="color:#a10606;">${productName}</span> has been dispatched.</p>
...
<tr>
  <td class="cp" style="padding:24px 32px 0;">
    <p style="margin:0;font-family:'Segoe UI',Arial,sans-serif;font-size:14px;color:#666666;line-height:1.6;">Once it lands, wear it with pride. Tag us <a href="https://instagram.com/chunkz_thebrand" style="color:#a10606;text-decoration:none;font-weight:700;">@chunkz_thebrand</a> 🔥</p>
  </td>
</tr>`;
